...
import com.github.jontejj.cell.physics.Wave;
...
public class JavaFxUI extends Application
{
	...
	{
		world = new World();
		// For JavaFX MyCanvas is ignored basically
		engine = new UIEngine(new MyCanvas(world));
	...
	public void start(Stage stage)
	{
		...
		car = new com.github.jontejj.cell.physics.Rectangle(10, 20, positionOfCar, uiUpdater);
		shapes.put(car, carUi);
		world.addObject(car);
		world.control(car);

		Vec2 upperLeftCorner = new Vec2(0, 0);
		com.github.jontejj.cell.physics.Rectangle leftWall = new com.github.jontejj.cell.physics.Rectangle(10.0f,
				1000.0f,
				upperLeftCorner,
				uiUpdater);
		Rectangle leftWallUi = new Rectangle(upperLeftCorner.magnitude(), upperLeftCorner.direction(), 10, 1000.0f);
		shapes.put(leftWall, leftWallUi);
		world.addObject(leftWall);
		// Second car
		// positionOfCar = new Vec2(500, 200);
		// carUi = new Rectangle(positionOfCar.magnitude(), positionOfCar.direction(), 10, 20);
		// car = new com.github.jontejj.cell.physics.Rectangle(10, 20, positionOfCar, uiUpdater);
		// shapes.put(car, carUi);
		// world.addObject(car);
