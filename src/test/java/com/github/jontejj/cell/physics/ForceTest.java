...
import static com.github.jontejj.cell.assertions.CustomAssertions.assertThat;
...
public class ForceTest
{
	...
	void testThatForceCanBeAppliedInDifferentDirections() throws Exception
	{
		...
		PhysicalObject flyingSaucer = new Circle(10, new Vec2(50, 100), ObjectUpdatedListener.VOID);
		...
		assertThat(newVelocity).isEqualTo(new Vec2(expectedXVelocity, expectedYVelocity), 0.1);
	}
	...
	void testThatForceForDefaultRotationMeansToTheRight() throws Exception
	{
		...
		// Default mass = 1, Rotation = 0
		PhysicalObject flyingSaucer = new Circle(10, new Vec2(0, 0), ObjectUpdatedListener.VOID);
	...
	void testThatOneForceInEachDirectionSumsToZeroNetForce() throws Exception
	{
		...
		assertThat(newVelocity).isEqualTo(new Vec2(expectedXVelocity, expectedYVelocity), 1e-10);
	}
